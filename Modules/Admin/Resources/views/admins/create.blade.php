            ...
            <form action="{{ route("admin.admins.add") }}" method="post">
                ...
                <div class="input-group mb-3">
                    <input value="{{ old('name') }}" name="name" type="text" class="form-control"
                        placeholder="{{__(' Firstname and Lastname ')}}">
                ...
                @enderror
                <div class="input-group mb-3">
                    <input value="{{ old('email') }}" name="email" type="tel" class="form-control" placeholder="{{__(' Email ')}}">
                    <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                    <input autocomplete="off" type="password" name="password_confirmation"
                        class="form-control password-input" placeholder="{{__(' Confirm Password ')}}">
                    <div class="input-group-append">
                        <span class="fa fa-lock input-group-text"></span>
                    </div>
                </div>
